...
const CardGallery = (props) => {
  return (
    <container className="group flex justify-center items-center">
      ...
      {/* 2nd frame */}
      <div className="z-10 absolute border-8 border-gray-300 shadow-xl rounded-sm transform rotate-2 group-hover:rotate-4 scale-100 sm:scale-110 group-hover:scale-115 transition-all duration-500 ease-in-out">
        <div className="hidden sm:block bg-yellow-900 opacity-90 md:w-max3 md:h-max2"></div>
      </div>

      {/* 3rd frame */}
      <div className="z-0 absolute border-8 border-gray-300 shadow-xl rounded-sm transform -rotate-3 group-hover:-rotate-4 scale-100 sm:scale-110 group-hover:scale-115 transition-all duration-500 ease-in-out">
