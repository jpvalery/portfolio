      ...
      <div className="flex justify-between py-6">
        ...
        <div className="-mr-2 -my-2 md:hidden">
          <button
            ...
            className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-accent hover:bg-gray-100 focus:outline-none"
          >
        ...
        <NextLink href="/featured-shots">
          ...
          <Menu>
            {({ open }) => (
              <>
                <Menu.Button className="group text-gray-500 inline-flex items-center text-base font-medium hover:text-accent ml-4 outline-none focus:outline-none">
                  <span>More</span>
                  <svg
